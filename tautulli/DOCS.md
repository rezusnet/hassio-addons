...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/tautulli"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8181` | TCP | `8181` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Tautulli > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-tautulli)
- [GitHub Repository](https://github.com/linuxserver/docker-tautulli)
