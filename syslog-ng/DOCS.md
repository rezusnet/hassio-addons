...
This add-on provides syslog-ng integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/syslog-ng)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:514
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-syslog-ng/)
