# Beets Add-on Documentation

## Getting Started

This add-on provides Beets integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/beets)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-beets/)
