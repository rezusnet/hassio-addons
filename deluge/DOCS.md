# Deluge Add-on Documentation

## Getting Started

This add-on provides Deluge integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/deluge)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8112
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-deluge/)
