...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/deluge"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8112` | TCP | `8112` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Deluge > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-deluge)
- [GitHub Repository](https://github.com/linuxserver/docker-deluge)
