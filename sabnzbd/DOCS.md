...
This add-on provides SABnzbd integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/sabnzbd)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-sabnzbd/)
