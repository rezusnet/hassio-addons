# Davos Add-on Documentation

## Getting Started

This add-on provides Davos integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/davos)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-davos/)
