# HTPC Manager Add-on Documentation

## Getting Started

This add-on provides HTPC Manager integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/htpcmanager)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8085
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-htpcmanager/)
