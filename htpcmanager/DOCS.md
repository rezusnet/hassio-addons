...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/htpcmanager"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8085` | TCP | `8085` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > HTPC Manager > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-htpcmanager)
- [GitHub Repository](https://github.com/linuxserver/docker-htpcmanager)
