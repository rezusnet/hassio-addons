# Jackett Add-on Documentation

## Getting Started

This add-on provides Jackett integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/jackett)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-jackett/)
