# NZBGet Add-on Documentation

## Getting Started

This add-on provides NZBGet integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/nzbget)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-nzbget/)
