# Planka Add-on Documentation

## Getting Started

This add-on provides Planka integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/planka)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-planka/)
