...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/mastodon"` | Data Location |
...
- Check logs: **Settings > Add-ons > Mastodon > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-mastodon)
- [GitHub Repository](https://github.com/linuxserver/docker-mastodon)
