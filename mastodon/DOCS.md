# Mastodon Add-on Documentation

## Getting Started

This add-on provides Mastodon integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/mastodon)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-mastodon/)
