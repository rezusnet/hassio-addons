...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/duplicati"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8200` | TCP | `8200` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Duplicati > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-duplicati)
- [GitHub Repository](https://github.com/linuxserver/docker-duplicati)
