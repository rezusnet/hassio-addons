...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/doplarr"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `7078` | TCP | `7078` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Doplarr > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-doplarr)
- [GitHub Repository](https://github.com/linuxserver/docker-doplarr)
