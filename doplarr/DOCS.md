# Doplarr Add-on Documentation

## Getting Started

This add-on provides Doplarr integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/doplarr)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:7078
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-doplarr/)
