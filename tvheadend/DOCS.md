# TVHeadend Add-on Documentation

## Getting Started

This add-on provides TVHeadend integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/tvheadend)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:9981
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-tvheadend/)
