...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/tvheadend"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `9981` | TCP | `9981` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > TVHeadend > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-tvheadend)
- [GitHub Repository](https://github.com/linuxserver/docker-tvheadend)
