# Mylar3 Add-on Documentation

## Getting Started

This add-on provides Mylar3 integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/mylar3)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8090
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-mylar3/)
