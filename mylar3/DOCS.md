...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/mylar3"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8090` | TCP | `8090` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Mylar3 > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-mylar3)
- [GitHub Repository](https://github.com/linuxserver/docker-mylar3)
