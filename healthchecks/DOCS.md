# Healthchecks Add-on Documentation

## Getting Started

This add-on provides Healthchecks integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/healthchecks)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-healthchecks/)
