# LibreSpeed Add-on Documentation

## Getting Started

This add-on provides LibreSpeed integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/librespeed)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-librespeed/)
