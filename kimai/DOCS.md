...
This add-on provides Kimai integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/kimai)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-kimai/)
