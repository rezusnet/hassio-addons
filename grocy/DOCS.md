...
This add-on provides Grocy integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/grocy)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-grocy/)
