...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/flexget"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `5050` | TCP | `5050` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Flexget > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-flexget)
- [GitHub Repository](https://github.com/linuxserver/docker-flexget)
