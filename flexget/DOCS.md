# Flexget Add-on Documentation

## Getting Started

This add-on provides Flexget integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/flexget)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-flexget/)
