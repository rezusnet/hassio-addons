...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/faster-whisper"` | Data Location |
...
- Check logs: **Settings > Add-ons > Faster Whisper > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-faster-whisper)
- [GitHub Repository](https://github.com/linuxserver/docker-faster-whisper)
