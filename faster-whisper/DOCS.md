# Faster Whisper Add-on Documentation

## Getting Started

This add-on provides Faster Whisper integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/faster-whisper)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-faster-whisper/)
