# WebGrab+Plus Add-on Documentation

## Getting Started

This add-on provides WebGrab+Plus integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/webgrabplus)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-webgrabplus/)
