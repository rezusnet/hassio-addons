# XBackBone Add-on Documentation

## Getting Started

This add-on provides XBackBone integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/xbackbone)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-xbackbone/)
