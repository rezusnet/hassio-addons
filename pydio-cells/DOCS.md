# Pydio Cells Add-on Documentation

## Getting Started

This add-on provides Pydio Cells integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/pydio-cells)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-pydio-cells/)
