...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/pydio-cells"` | Data Location |
...
- Check logs: **Settings > Add-ons > Pydio Cells > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-pydio-cells)
- [GitHub Repository](https://github.com/linuxserver/docker-pydio-cells)
