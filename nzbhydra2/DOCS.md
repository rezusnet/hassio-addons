...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/nzbhydra2"` | Data Location |
...
- Check logs: **Settings > Add-ons > NZBHydra2 > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-nzbhydra2)
- [GitHub Repository](https://github.com/linuxserver/docker-nzbhydra2)
