# Piper Add-on Documentation

## Getting Started

This add-on provides Piper integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/piper)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-piper/)
