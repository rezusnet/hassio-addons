# Lychee Add-on Documentation

## Getting Started

This add-on provides Lychee integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/lychee)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-lychee/)
