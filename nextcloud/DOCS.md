# Nextcloud Add-on Documentation

## Getting Started

This add-on provides Nextcloud integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/nextcloud)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-nextcloud/)
