# HaBridge Add-on Documentation

## Getting Started

This add-on provides HaBridge integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/habridge)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-habridge/)
