# Piwigo Add-on Documentation

## Getting Started

This add-on provides Piwigo integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/piwigo)
