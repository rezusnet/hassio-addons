...
This add-on provides Bookstack integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/bookstack)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-bookstack/)
