# mStream Add-on Documentation

## Getting Started

This add-on provides mStream integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/mstream)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-mstream/)
