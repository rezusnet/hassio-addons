...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/kometa"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8191` | TCP | `8191` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Kometa > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-kometa)
- [GitHub Repository](https://github.com/linuxserver/docker-kometa)
