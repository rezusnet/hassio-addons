# Kometa Add-on Documentation

## Getting Started

This add-on provides Kometa integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/kometa)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8191
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-kometa/)
