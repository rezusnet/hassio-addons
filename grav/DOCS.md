# Grav Add-on Documentation

## Getting Started

This add-on provides Grav integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/grav)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-grav/)
