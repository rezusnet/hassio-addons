...
| `data_location` | string | `"/share/sonarr"` | Data Location |
...
- Check logs: **Settings > Add-ons > Sonarr > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://sonarr.tv)
- [GitHub Repository](https://github.com/linuxserver/docker-sonarr)
