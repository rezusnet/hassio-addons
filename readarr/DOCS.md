...
This add-on provides Readarr integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/readarr)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8787
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-readarr/)
