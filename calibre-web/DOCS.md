# Calibre-Web Add-on Documentation

## Getting Started

This add-on provides Calibre-Web integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/calibre-web)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-calibre-web/)
