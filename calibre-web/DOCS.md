...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/calibre-web"` | Data Location |
...
- Check logs: **Settings > Add-ons > Calibre-Web > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-calibre-web)
- [GitHub Repository](https://github.com/linuxserver/docker-calibre-web)
