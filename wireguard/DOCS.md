...
This add-on provides WireGuard integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/wireguard)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:51820
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-wireguard/)
