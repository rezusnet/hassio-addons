...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/wireguard"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `51820` | TCP | `51820` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > WireGuard > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-wireguard)
- [GitHub Repository](https://github.com/linuxserver/docker-wireguard)
