# HedgeDoc Add-on Documentation

## Getting Started

This add-on provides HedgeDoc integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/hedgedoc)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-hedgedoc/)
