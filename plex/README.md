...
[Plex Media Server](https://github.com/linuxserver/docker-plex) is a powerful application for managing and organizing media content.
...
2. Install the **Plex Media Server** add-on
