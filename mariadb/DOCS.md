# MariaDB Add-on Documentation

## Getting Started

This add-on provides MariaDB integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/mariadb)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:3306
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-mariadb/)
