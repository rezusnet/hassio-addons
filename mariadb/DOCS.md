...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/mariadb"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `3306` | TCP | `3306` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > MariaDB > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-mariadb)
- [GitHub Repository](https://github.com/linuxserver/docker-mariadb)
