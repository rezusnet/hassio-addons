...
This add-on provides Wireshark integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/wireshark)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-wireshark/)
