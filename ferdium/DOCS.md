# Ferdium Add-on Documentation

## Getting Started

This add-on provides Ferdium integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/ferdium)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-ferdium/)
