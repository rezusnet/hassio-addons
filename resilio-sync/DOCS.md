# Resilio Sync Add-on Documentation

## Getting Started

This add-on provides Resilio Sync integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/resilio-sync)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8888
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-resilio-sync/)
