...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/resilio-sync"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8888` | TCP | `8888` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Resilio Sync > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-resilio-sync)
- [GitHub Repository](https://github.com/linuxserver/docker-resilio-sync)
