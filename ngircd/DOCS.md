...
This add-on provides ngIRCd integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/ngircd)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:6667
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-ngircd/)
