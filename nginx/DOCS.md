# Nginx Add-on Documentation

## Getting Started

This add-on provides Nginx integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/nginx)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-nginx/)
