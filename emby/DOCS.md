...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/emby"` | Data Location |
...
- Check logs: **Settings > Add-ons > Emby > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-emby)
- [GitHub Repository](https://github.com/linuxserver/docker-emby)
