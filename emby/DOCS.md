# Emby Add-on Documentation

## Getting Started

This add-on provides Emby integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/emby)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8096
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-emby/)
