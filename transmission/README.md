...
[Transmission](https://transmissionbt.com/) is a fast, easy, and free BitTorrent client. It features a simple web interface, watch directory support, and minimal resource usage.
...
- Low resource usage, ideal for Raspberry Pi
