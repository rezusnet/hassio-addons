...
[Transmission](https://transmissionbt.com) is lightweight and open-source BitTorrent client for all platforms.
...
4. Start the add-on.
5. Access via the **HA sidebar** (Ingress) or directly at `http://<your-ha-ip>:51413`.
