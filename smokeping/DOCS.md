...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/smokeping"` | Data Location |
...
- Check logs: **Settings > Add-ons > SmokePing > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-smokeping)
- [GitHub Repository](https://github.com/linuxserver/docker-smokeping)
