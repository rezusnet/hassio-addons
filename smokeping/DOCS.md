# SmokePing Add-on Documentation

## Getting Started

This add-on provides SmokePing integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/smokeping)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-smokeping/)
