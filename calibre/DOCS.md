# Calibre Add-on Documentation

## Getting Started

This add-on provides Calibre integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/calibre)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-calibre/)
