...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/kavita"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `5000` | TCP | `5000` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Kavita > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-kavita)
- [GitHub Repository](https://github.com/linuxserver/docker-kavita)
