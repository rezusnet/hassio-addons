# Kavita Add-on Documentation

## Getting Started

This add-on provides Kavita integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/kavita)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:5000
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-kavita/)
