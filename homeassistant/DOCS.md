# Home Assistant (LSIO) Add-on Documentation

## Getting Started

This add-on provides Home Assistant (LSIO) integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/homeassistant)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8123
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-homeassistant/)
