...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/homeassistant"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8123` | TCP | `8123` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Home Assistant (LSIO) > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-homeassistant)
- [GitHub Repository](https://github.com/linuxserver/docker-homeassistant)
