# PairDrop Add-on Documentation

## Getting Started

This add-on provides PairDrop integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/pairdrop)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-pairdrop/)
