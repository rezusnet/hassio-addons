...
[OpenCode](https://github.com/anomalyco/opencode) is opencode is an open source ai coding agent. it provides a browser-based interface for ai-powered code editing, analysis, and development with support for multiple llm providers..

This add-on is based on the [linuxserver/docker-opencode](https://github.com/linuxserver/docker-opencode) Docker image.
