...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/lidarr"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8686` | TCP | `8686` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Lidarr > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-lidarr)
- [GitHub Repository](https://github.com/linuxserver/docker-lidarr)
