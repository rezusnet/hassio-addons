...
This add-on provides Lidarr integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/lidarr)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8686
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-lidarr/)
