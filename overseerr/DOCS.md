...
This add-on provides Overseerr integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/overseerr)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-overseerr/)
