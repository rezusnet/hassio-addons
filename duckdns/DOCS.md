# DuckDNS Add-on Documentation

## Getting Started

This add-on provides DuckDNS integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/duckdns)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-duckdns/)
