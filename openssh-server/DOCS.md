...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/openssh-server"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `2222` | TCP | `2222` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > OpenSSH Server > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-openssh-server)
- [GitHub Repository](https://github.com/linuxserver/docker-openssh-server)
