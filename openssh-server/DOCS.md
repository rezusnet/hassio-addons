# OpenSSH Server Add-on Documentation

## Getting Started

This add-on provides OpenSSH Server integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/openssh-server)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:2222
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-openssh-server/)
