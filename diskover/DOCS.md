# Diskover Add-on Documentation

## Getting Started

This add-on provides Diskover integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/diskover)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-diskover/)
