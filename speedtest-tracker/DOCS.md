...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/speedtest-tracker"` | Data Location |
...
- Check logs: **Settings > Add-ons > Speedtest Tracker > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-speedtest-tracker)
- [GitHub Repository](https://github.com/linuxserver/docker-speedtest-tracker)
