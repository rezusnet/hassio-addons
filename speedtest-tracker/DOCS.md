# Speedtest Tracker Add-on Documentation

## Getting Started

This add-on provides Speedtest Tracker integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/speedtest-tracker)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:80
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-speedtest-tracker/)
