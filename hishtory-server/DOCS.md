...
This add-on provides hiSHtory Server integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/hishtory-server)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:7600
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-hishtory-server/)
