# rsnapshot Add-on Documentation

## Getting Started

This add-on provides rsnapshot integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/rsnapshot)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-rsnapshot/)
