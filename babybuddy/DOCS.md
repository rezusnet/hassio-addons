# Baby Buddy Add-on Documentation

## Getting Started

This add-on provides Baby Buddy integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/babybuddy)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-babybuddy/)
