...
[Filebrowser](https://filebrowser.org) is web-based file manager for browsing, uploading, editing, and sharing files from your home assistant system and mounted storage..

This add-on is based on the [linuxserver/docker-filebrowser](https://github.com/linuxserver/docker-filebrowser) Docker image.
