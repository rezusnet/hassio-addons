# Spotube Add-on Documentation

## Getting Started

This add-on provides Spotube integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/spotube)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-spotube/)
