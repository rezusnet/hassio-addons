# Monica Add-on Documentation

## Getting Started

This add-on provides Monica integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/monica)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-monica/)
