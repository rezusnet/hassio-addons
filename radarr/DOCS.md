...
1. Open Radarr via the **HA sidebar** (Ingress) or at `http://<your-ha-ip>:7878`
2. Complete the setup wizard
3. Add your movie libraries pointing to media directories (e.g., `/media/movies`, `/share/radarr/movies`)
...
| `data_location` | str  | `/share/radarr` | Path where Radarr stores config and data        |
...
| --------------- | -------------------------------- | ---------- |
| `/share/radarr` | Configurable via `data_location` | Read/Write |
...
For best results with hardlinks and atomic moves, use consistent paths inside Radarr.
Point your movie root folder to `/media/movies` or `/share/radarr/movies`.
...
| ------ | -------- | ------- | ------------- |
| `7878` | TCP      | `7878`  | Web interface |

## Upstream Documentation

- [Radarr Wiki](https://wiki.servarr.com/radarr)
- [Servarr Docker Guide](https://wiki.servarr.com/docker-guide)
- [LinuxServer Docker Image](https://github.com/linuxserver/docker-radarr)
