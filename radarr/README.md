...
[Radarr](https://radarr.video/) is a movie collection manager for Usenet and BitTorrent users. It monitors multiple sources for new movies and manages downloading and organization.

This add-on is based on the [linuxserver/docker-radarr](https://github.com/linuxserver/docker-radarr) Docker image.

**Key features:**

- Monitor and download movies automatically
- Support for Usenet and BitTorrent download clients
