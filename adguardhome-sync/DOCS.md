...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/adguardhome-sync"` | Data Location |
...
- Check logs: **Settings > Add-ons > AdGuard Home Sync > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-adguardhome-sync)
- [GitHub Repository](https://github.com/linuxserver/docker-adguardhome-sync)
