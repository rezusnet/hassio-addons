# AdGuard Home Sync Add-on Documentation

## Getting Started

This add-on provides AdGuard Home Sync integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/adguardhome-sync)
