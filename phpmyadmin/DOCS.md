...
This add-on provides phpMyAdmin integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/phpmyadmin)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-phpmyadmin/)
