# DokuWiki Add-on Documentation

## Getting Started

This add-on provides DokuWiki integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/dokuwiki)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-dokuwiki/)
