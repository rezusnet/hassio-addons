# Minisatip Add-on Documentation

## Getting Started

This add-on provides Minisatip integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/minisatip)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-minisatip/)
