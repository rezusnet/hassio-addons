...
This add-on provides ddclient integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/ddclient)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-ddclient/)
