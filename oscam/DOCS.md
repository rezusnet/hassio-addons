...
This add-on provides OSCam integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/oscam)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-oscam/)
