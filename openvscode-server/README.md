...
[OpenVSCode Server](https://github.com/linuxserver/docker-openvscode-server) is a powerful application for managing and organizing media content.
...
2. Install the **OpenVSCode Server** add-on
