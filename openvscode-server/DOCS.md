...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/openvscode-server"` | Data Location |
...
- Check logs: **Settings > Add-ons > OpenVSCode Server > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-openvscode-server)
- [GitHub Repository](https://github.com/linuxserver/docker-openvscode-server)
