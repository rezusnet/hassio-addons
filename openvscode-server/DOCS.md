# OpenVSCode Server Add-on Documentation

## Getting Started

This add-on provides OpenVSCode Server integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/openvscode-server)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:3000
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-openvscode-server/)
