...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/freshrss"` | Data Location |
...
- Check logs: **Settings > Add-ons > FreshRSS > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-freshrss)
- [GitHub Repository](https://github.com/linuxserver/docker-freshrss)
