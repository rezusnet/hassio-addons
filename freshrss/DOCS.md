# FreshRSS Add-on Documentation

## Getting Started

This add-on provides FreshRSS integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/freshrss)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-freshrss/)
