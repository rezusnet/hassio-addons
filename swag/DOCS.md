# SWAG Add-on Documentation

## Getting Started

This add-on provides SWAG integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/swag)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-swag/)
