# LazyLibrarian Add-on Documentation

## Getting Started

This add-on provides LazyLibrarian integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/lazylibrarian)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8383
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-lazylibrarian/)
