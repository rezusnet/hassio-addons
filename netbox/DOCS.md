...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/netbox"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8001` | TCP | `8001` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > NetBox > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-netbox)
- [GitHub Repository](https://github.com/linuxserver/docker-netbox)
