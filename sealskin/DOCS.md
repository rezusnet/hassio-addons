# SealSkin Add-on Documentation

## Getting Started

This add-on provides SealSkin integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/sealskin)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-sealskin/)
