...
This add-on provides Ombi integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/ombi)
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-ombi/)
