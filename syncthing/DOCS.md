...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/syncthing"` | Data Location |
...
| ---- | -------- | ------- | ----------- |
| `8384` | TCP | `8384` | Web interface |

## Troubleshooting

### Add-on won't start

- Check logs: **Settings > Add-ons > Syncthing > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-syncthing)
- [GitHub Repository](https://github.com/linuxserver/docker-syncthing)
