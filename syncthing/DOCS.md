# Syncthing Add-on Documentation

## Getting Started

This add-on provides Syncthing integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/syncthing)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8384
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-syncthing/)
