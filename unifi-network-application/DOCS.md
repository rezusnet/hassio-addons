...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/unifi-network-application"` | Data Location |
...
- Check logs: **Settings > Add-ons > UniFi Network Application > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-unifi-network-application)
- [GitHub Repository](https://github.com/linuxserver/docker-unifi-network-application)
