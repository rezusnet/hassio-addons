...
[UniFi Network Application](https://github.com/linuxserver/docker-unifi-network-application) is a powerful application for managing and organizing media content.
...
2. Install the **UniFi Network Application** add-on
