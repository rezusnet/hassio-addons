...
## 5.2.3_v2.0.15-ls478 (2026-09-26)

Upstream image rebuild (`5.2.3_v2.0.14-ls477` → `5.2.3_v2.0.15-ls478`) — packaging / base-image refresh, no application changes (qBittorrent **5.2.3**).
