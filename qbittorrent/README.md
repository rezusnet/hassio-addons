...
[qBittorrent](https://www.qbittorrent.org) is free and reliable BitTorrent client with advanced features.
...
4. Start the add-on.
5. Access via the **HA sidebar** (Ingress) or directly at `http://<your-ha-ip>:6881`.
