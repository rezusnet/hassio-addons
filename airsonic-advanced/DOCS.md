# Airsonic Advanced Add-on Documentation

## Getting Started

This add-on provides Airsonic Advanced integration with Home Assistant.
...
- **data_location**: Where data is stored (default: /share/airsonic-advanced)

### Usage

Once started, access the application through:
- Home Assistant Ingress (if enabled)
- Direct URL: http://<your-ha-ip>:8080
...
- [LinuxServer.io Documentation](https://docs.linuxserver.io/images/docker-airsonic-advanced/)
