...
| `PUID` | int | `0` | Puid |
| `TZ` | string | `""` | Tz |
| `data_location` | string | `"/share/airsonic-advanced"` | Data Location |
...
- Check logs: **Settings > Add-ons > Airsonic Advanced > Logs**
- Verify all required options are configured
- Check that required ports are available

## Upstream Documentation

- [Project Homepage](https://github.com/linuxserver/docker-airsonic-advanced)
- [GitHub Repository](https://github.com/linuxserver/docker-airsonic-advanced)
